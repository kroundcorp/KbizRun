...
const MENTORS = [
  { name: '홍순후', role: '조달청 前 조달교육원장', exp: '34년', rating: 4.9, sessions: 218 },
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        {MENTORS.map((m) => (
          <div key={m.name} className="bg-white rounded-3xl border border-gray-200 p-6 hover:border-blue-300 transition-colors">
            ...
            <button className="w-full bg-blue-50 text-blue-700 font-bold py-3 rounded-xl hover:bg-blue-600 hover:text-white transition-colors">
              상담 신청
            </button>
          </div>
        ))}
