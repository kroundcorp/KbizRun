...
export const books: Book[] = [
  {
    ...
    description:
      '공공조달관리사 시험의 전 범위를 체계적으로 정리한 기본서입니다. 40년 경력의 홍순후 교수가 집필 및 검수하여 최신 법령과 실무 사례를 완벽 반영했습니다.',
    features: [
      '2026년 개정법령 100% 반영',
      '조달 전문가 직접 집필·검수',
      '영역별 핵심 요약 + 예상문제 수록',
  ...
  },
  {
    ...
    description:
      '출제 기준과 최신 법령을 반영한 예상문제와 변형 문제를 수록한 실전 문제집입니다. 상세한 해설과 함께 오답 노트 양식도 제공합니다.',
    features: [
      '예상문제 + 변형 1,200문항',
      '전 문항 상세 해설',
      '영역별 출제빈도 분석',
  ...
  },
  {
    ...
    description:
      '기본서, 예상문제집, 핵심 요약서를 묶은 합격 올인원 세트입니다. 세트 구매 시 온라인 강의 쿠폰 3개월권이 함께 제공됩니다.',
    features: [
      '기본서 + 문제집 + 요약서 구성',
      '세트 10% 할인 적용',
      '온라인 강의 3개월 쿠폰 증정',
