...
export const events: EventItem[] = [
  { id: 1, title: '신규가입 EVENT — 예상문제 샘플 무료', tag: 'HOT', period: '2026.03.01 ~ 2026.03.31', summary: '가입만 해도 예상문제 샘플 + 해설 PDF 제공', status: 'active', color: 'purple' },
  { id: 2, title: '4월 이용권 20% 할인', tag: 'SALE', period: '2026.04.01 ~ 2026.04.30', summary: '필기+실기 올인원 이용권 특별 할인', status: 'active', color: 'red' },
